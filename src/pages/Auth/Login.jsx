        ...
        <div className="login-box">
          ...
          {/* Google Login */}
            <button
              ...
              onMouseEnter={(e) => { if (!googleLoading) e.currentTarget.style.borderColor = 'var(--red)' }}
            ...
            >
              ...
              {googleLoading ? t('common.loading') || 'Cargando...' : t('auth.continueWithGoogle') || 'Continuar con Google'}
            </button>
