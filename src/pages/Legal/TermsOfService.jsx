  ...
  es: {
    ...
    sections: [
      { title: '1. Aceptación de los Términos', content: [
        'Al crear una cuenta y usar PodioF1, aceptás estos términos y condiciones en su totalidad. Si no estás de acuerdo, no uses la aplicación.'
      ]},
      { title: '2. Descripción del Servicio', content: [
        'PodioF1 es una plataforma de entretenimiento que permite a los usuarios crear predicciones sobre resultados de carreras de Fórmula 1 y competir con amigos en grupos privados.',
      ...
      { title: '5. No es Plataforma de Apuestas', content: [
        '<div class="legal-highlight">⚠️ <strong>IMPORTANTE:</strong> PodioF1 es exclusivamente un juego de entretenimiento. NO es una plataforma de apuestas y NO facilita, gestiona, almacena ni transfiere dinero de ningún tipo.<br/><br/>La función "Pozo del Grupo" es meramente informativa. PodioF1 no tiene responsabilidad alguna sobre acuerdos económicos entre usuarios.<br/><br/>El uso de la app para apuestas reales queda bajo la exclusiva responsabilidad de los usuarios y está sujeto a las leyes aplicables en su jurisdicción.</div>'
      ]},
      { title: '6. Propiedad Intelectual', content: [
        'PodioF1, su diseño, código y contenido son propiedad de PodioF1. Los nombres, logos y marcas de Fórmula 1, equipos y pilotos son propiedad de sus respectivos titulares y se usan con fines informativos.',
        'Los datos de resultados de carreras se obtienen de fuentes públicas (OpenF1 API) y son de dominio público.'
      ]},
      { title: '7. Contenido del Usuario', content: [
        'Las predicciones y datos que envíes son tu contenido. Al usar la app, otorgás a PodioF1 una licencia no exclusiva para mostrar tus predicciones a otros miembros de tus grupos y para generar estadísticas agregadas.'
      ]},
      ...
      { title: '10. Limitación de Responsabilidad', content: [
        'PodioF1 se proporciona "tal cual" sin garantías. No somos responsables de:',
      ...
      { title: '11. Eliminación de Cuenta', content: [
        ...
        'También podés solicitar la eliminación por email a <a href="mailto:privacy@podiof1.com">privacy@podiof1.com</a>'
      ]},
      ...
      { title: '13. Contacto', content: [
        'Email: <a href="mailto:legal@podiof1.com">legal@podiof1.com</a><br/>Web: <a href="https://podiof1.com">podiof1.com</a>'
      ]}
    ]
  },
  en: {
    ...
    sections: [
      { title: '1. Acceptance of Terms', content: [
        'By creating an account and using PodioF1, you accept these terms and conditions in their entirety. If you disagree, do not use the application.'
      ]},
      { title: '2. Service Description', content: [
        'PodioF1 is an entertainment platform that allows users to create predictions about Formula 1 race results and compete with friends in private groups.',
      ...
      { title: '4. Acceptable Use', content: [
        'By using PodioF1, you agree not to:',
      ...
      { title: '5. Not a Gambling Platform', content: [
        '<div class="legal-highlight">⚠️ <strong>IMPORTANT:</strong> PodioF1 is exclusively an entertainment game. It is NOT a gambling platform and does NOT facilitate, manage, store or transfer money of any kind.<br/><br/>The "Group Prize Pool" feature is purely informational. PodioF1 bears no responsibility for economic agreements between users.<br/><br/>Use of the app for real gambling is the sole responsibility of users and is subject to applicable laws in their jurisdiction.</div>'
      ]},
      { title: '6. Intellectual Property', content: [
        'PodioF1, its design, code and content are property of PodioF1. Formula 1 names, logos and trademarks of teams and drivers are property of their respective owners and are used for informational purposes.',
        'Race result data is obtained from public sources (OpenF1 API) and is in the public domain.'
      ]},
      { title: '7. User Content', content: [
        'Predictions and data you submit are your content. By using the app, you grant PodioF1 a non-exclusive license to display your predictions to other group members and to generate aggregate statistics.'
      ]},
      ...
      { title: '10. Limitation of Liability', content: [
        'PodioF1 is provided "as is" without warranties. We are not responsible for:',
      ...
      { title: '11. Account Deletion', content: [
        ...
        'You can also request deletion by email at <a href="mailto:privacy@podiof1.com">privacy@podiof1.com</a>'
      ]},
  ...
  pt: {
    ...
    sections: [
      { title: '1. Aceitação dos Termos', content: [
        'Ao criar uma conta e usar o PodioF1, você aceita estes termos e condições em sua totalidade. Se não concordar, não use o aplicativo.'
      ]},
      { title: '2. Descrição do Serviço', content: [
        'PodioF1 é uma plataforma de entretenimento que permite aos usuários criar previsões sobre resultados de corridas de Fórmula 1 e competir com amigos em grupos privados.',
      ...
      { title: '4. Uso Aceitável', content: [
        'Ao usar o PodioF1, você concorda em não:',
      ...
      { title: '5. Não é Plataforma de Apostas', content: [
        '<div class="legal-highlight">⚠️ <strong>IMPORTANTE:</strong> PodioF1 é exclusivamente um jogo de entretenimento. NÃO é uma plataforma de apostas e NÃO facilita, gerencia, armazena ou transfere dinheiro de nenhum tipo.<br/><br/>O recurso "Bolão do Grupo" é meramente informativo. PodioF1 não tem responsabilidade alguma sobre acordos econômicos entre usuários.<br/><br/>O uso do app para apostas reais fica sob a exclusiva responsabilidade dos usuários e está sujeito às leis aplicáveis em sua jurisdição.</div>'
      ]},
      { title: '6. Propriedade Intelectual', content: [
        'PodioF1, seu design, código e conteúdo são propriedade do PodioF1. Nomes, logos e marcas de Fórmula 1, equipes e pilotos são propriedade de seus respectivos titulares e são usados para fins informativos.',
        'Os dados de resultados de corridas são obtidos de fontes públicas (OpenF1 API) e são de domínio público.'
      ]},
      { title: '7. Conteúdo do Usuário', content: [
        'As previsões e dados que você envia são seu conteúdo. Ao usar o app, você concede ao PodioF1 uma licença não exclusiva para exibir suas previsões aos outros membros dos seus grupos e para gerar estatísticas agregadas.'
      ]},
      ...
      { title: '10. Limitação de Responsabilidade', content: [
        'PodioF1 é fornecido "como está" sem garantias. Não somos responsáveis por:',
      ...
      { title: '11. Exclusão de Conta', content: [
        ...
        'Também pode solicitar a exclusão por e-mail em <a href="mailto:privacy@podiof1.com">privacy@podiof1.com</a>'
      ]},
      ...
      { title: '13. Contato', content: [
        'E-mail: <a href="mailto:legal@podiof1.com">legal@podiof1.com</a><br/>Web: <a href="https://podiof1.com">podiof1.com</a>'
      ]}
    ]
  }
};
